 ...
 */
final class Version20220523153216 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article CHANGE creation_date creation_date DATE DEFAULT \'CURRENT_TIMESTAMP\' NOT NULL');
    }
}
